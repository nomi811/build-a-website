...
> Note: If you are not seeing these changes and you've definitely added the CSS correctly you may need to restart your Cloud9 workspace.  Make sure you've saved your files first!
...
First, we'll add a container element with an id of `caption-controls` after the workspace element in `index.erb`:
